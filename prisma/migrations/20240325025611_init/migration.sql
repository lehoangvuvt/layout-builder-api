/*
  ...
  - Changed the type of `authorId` on the `Layout` table. No cast exists, the column would be dropped and recreated, which cannot be done if there is data, since the column is required.

*/
-- DropForeignKey
ALTER TABLE "Layout" DROP CONSTRAINT "Layout_authorId_fkey";
